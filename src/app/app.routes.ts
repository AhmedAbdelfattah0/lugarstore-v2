...
import { LgProductsPageComponent } from './features/products/pages/lg-products-page/lg-products-page.component';
import { LgProductDetailPageComponent } from './features/product-detail/pages/lg-product-detail-page/lg-product-detail-page.component';
...
import { LgOrderSuccessPageComponent } from './features/checkout/pages/lg-order-success-page/lg-order-success-page.component';
...
export const routes: Routes = [
  ...
  { path: 'products',     component: LgProductsPageComponent },
  { path: 'products/:id', component: LgProductDetailPageComponent },
  { path: 'cart',         component: LgCartPageComponent },
  { path: 'wishlist',     component: LgWishlistPageComponent },
  { path: 'checkout',     canActivate: [checkoutGuard], component: LgCheckoutPageComponent },
  { path: 'order-success', component: LgOrderSuccessPageComponent },
